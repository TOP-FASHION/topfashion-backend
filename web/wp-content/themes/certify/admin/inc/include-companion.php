				...
				<li id="accordion-section-<?php echo esc_attr($this->id); ?>" class="<?php echo esc_attr($classes); ?>">
					...
					<?php 
					 ...
					 ?>
						...
						<a class="spicethemes-plugin-install install-now button-secondary button" data-slug="spicebox" href="<?php echo esc_url_raw($plugin_install_url); ?>" aria-label="<?php esc_attr_e('Install SpiceBox Now', 'certify');?>" data-name="<?php esc_attr_e('SpiceBox', 'certify'); ?>">
					...
					<?php else: ?>
						...
						<a class="spicethemes-plugin-activate activate-now button-primary button" data-slug="spicebox" href="<?php echo esc_url_raw($plugin_activate_link); ?>" aria-label="<?php esc_attr_e('Activate SpiceBox now', 'certify');?>" data-name="<?php esc_attr_e('SpiceBox', 'certify'); ?>">
