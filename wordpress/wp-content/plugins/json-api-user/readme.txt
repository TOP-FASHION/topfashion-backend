...
* Always use POST method and not GET to submit data, following url examples are only for demonstration purposes.
...
For additional endpoints, pro version JSON APi User Plus plugin details check here http://www.parorrey.com/solutions/json-api-user-plus/
